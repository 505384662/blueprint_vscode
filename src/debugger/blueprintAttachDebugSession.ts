...
interface blueprintAttachDebugArguments extends DebugProtocol.AttachRequestArguments {
...
export class blueprintAttachDebugSession extends blueprintDebugSession {
    ...
    async attachRequest(response: DebugProtocol.AttachResponse, args: blueprintAttachDebugArguments) {
