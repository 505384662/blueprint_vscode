...
function createDecoration(key: string | undefined, config: vscode.DecorationRenderOptions = {}): vscode.TextEditorDecorationType {
    ...
    let color = vscode.workspace.getConfiguration("blueprintlua").get(key);
...
function updateDecorations() {
    ...
    let upvalueColor = vscode.workspace.getConfiguration("blueprintlua").get("colors.upvalue");
...
function requestAnnotatorsImpl(editor: vscode.TextEditor, client: LanguageClient) {
    ...
    client.sendRequest<notifications.IAnnotator[]>("blueprint/annotator", params).then(list => {
