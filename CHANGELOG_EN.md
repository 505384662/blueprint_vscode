...
`NEW` blueprintlua debugger compilation standard raised to C++11
...
format:
* Remove the current formatting algorithm, the blueprintLua plugin no longer provides formatting algorithms
* Formatting is implemented by the plug-in blueprintLuaCodeStyle
